...
def index(request):
    ...
    # checking if the method is POST
        if request.method == 'POST':
            API_KEY = 'b99f518ebad72eb7147ac19c3e3348bd'
            # getting the city name from the form input   
            city_name = request.POST.get('city')
            # the url for current weather, takes city_name and API_KEY   
            url = f'https://api.openweathermap.org/data/2.5/weather?q={city_name}&appid=b99f518ebad72eb7147ac19c3e3348bd&units=metric'
